...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    console.log('Submitting registration request:', form); // Log request data
    ...
    try {
      ...
      console.error('Registration failed:', errorDetails); // Log error details
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '400px', margin: '0 auto' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <TextField name="phoneNumber" label="Phone Number" fullWidth margin="normal" onChange={handleChange} />
